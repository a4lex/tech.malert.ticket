...
const SigninScreen = ({navigation}) => {
  ...
  const loginHandle = (mail, password) => {
    if (data.mail.length === 0 || data.password.length === 0) {
      Alert.alert('Error', 'EMail or password field cannot be empty.', [
        {text: 'Ok'},
      ]);
      return;
    }
        ...
        <Animatable.View
          ...
          <View style={styles.action}>
            ...
            {data.check_textInputChange ? (
              <Animatable.View animation="bounceIn">
                <Feather name="check-circle" color={colors.blue} size={20} />
              </Animatable.View>
            ) : null}
          </View>
          ...
          <View style={styles.button}>
            <TouchableOpacity
              style={styles.signin}
              onPress={() => {
                loginHandle(data.mail, data.password);
              }}>
            ...
            <TouchableOpacity
              ...
              style={{...styles.signup, borderColor: colors.blue}}>
              <Text style={{...styles.textSign, color: colors.blue}}>
                Sign Up
              </Text>
            </TouchableOpacity> */}
          </View>
